...
// Check if the student is already logged in, if so redirect to dashboard
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, full_name, password_hash FROM students WHERE username = ?";
...
<div class="auth-container">
    <div class="login-box">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <hr>
            <p style="text-align: center;"><a href="../admin/login.php">Admin Login</a></p>
        </form>
    </div>
</div>
